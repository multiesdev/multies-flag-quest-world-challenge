...
fun AboutScreen(
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text(text = stringResource(R.string.about_and_data), fontWeight = FontWeight.Bold) },
                navigationIcon = {
            ...
            Card(
                ...
                Column(modifier = Modifier.padding(16.dp)) {
                    Row(verticalAlignment = Alignment.CenterVertically) {
                        ...
                        Text(
                            text = stringResource(R.string.about_and_data),
            ...
            Card(
                ...
                Column(modifier = Modifier.padding(16.dp), verticalArrangement = Arrangement.spacedBy(12.dp)) {
                    Row(verticalAlignment = Alignment.CenterVertically) {
                        ...
                        Spacer(modifier = Modifier.width(12.dp))
                        Text(
                            text = stringResource(R.string.local_persistence_title),
                            style = MaterialTheme.typography.titleMedium,
                            fontWeight = FontWeight.Bold
                        )
                    }
                    Text(
                        text = stringResource(R.string.local_persistence_desc),
                        style = MaterialTheme.typography.bodyMedium,
                        color = MaterialTheme.colorScheme.onSurface
                    )
